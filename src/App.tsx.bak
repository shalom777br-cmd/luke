          ...
          <section className="lg:col-span-5 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-teal-200 p-6 shadow-xs space-y-4 relative overflow-hidden">
              ...
              <div className="flex items-center gap-2 pb-2 border-b border-slate-100">
                ...
                <h3 className="text-sm font-bold text-slate-900">ノアの心身・お悩み観察モニタ</h3>
                  ...
                  return (
                    <div className="space-y-3">
                      <p className="text-xs text-slate-500 leading-relaxed">
                        現在、心身の健康状態やデリケートなお悩みに関する記録（<strong>{healthWorries.length}件</strong>）が検出され、秘書ノアが最優先で観察しています。
                      </p>
                      <div className="space-y-3 max-h-64 overflow-y-auto pr-1">
                        {healthWorries.map((worry) => (
                          <div key={worry.id} className="bg-teal-50/40 rounded-xl p-3 border border-teal-100/80 space-y-2 text-xs">
                            ...
                            {/* Custom caring comment from Noah based on importance */}
                  ...
                  return (
                    <div className="text-center py-6 text-slate-400 bg-slate-50/50 rounded-xl border border-dashed border-slate-200 text-xs space-y-2">
                      ...
                      <div className="bg-white/80 p-2.5 rounded-lg border border-slate-100 text-left max-w-xs mx-auto text-[11px] text-slate-500 italic leading-normal">
                        <strong>ノア:</strong> 「健康的なコンディションですね！もし体調の違和感やメンタルの不調、気がかりなお悩みがあれば、どんなに小さなことでも声で吹き込んでおいてください。私がしっかり観測し、最優先でサポートします。」
                      </div>
                    </div>
                  );
                }
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-5">
              ...
              {activeSearchTab === 'personal' ? (
                ...
                <div className="space-y-4 pt-1">
                  {/* Public Search Form */}
                  <form onSubmit={handleSearchPublic} className="relative">
                    <input
                      type="text"
                    ...
                    <button
                      ...
                      className="absolute right-1.5 top-1.5 p-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-all disabled:opacity-55 flex items-center justify-center active:scale-95 shadow-xs"
                      title="公開記憶を検索"
                    >
                      {isSearchingPublic ? (
                  ...
                  <div className="space-y-2.5">
                    <div className="text-[11px] font-bold text-slate-500 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="text-indigo-600 hover:text-indigo-800 flex items-center gap-0.5 font-bold"
                      >
                        <RefreshCw className="h-3 w-3" />
                        <span>最新化</span>
                      </button>
